...
/*   Updated: 2021/10/27 16:50:07 by cdapurif         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_side(t_player *p, float move_step)
{
	float	new_player_x;
	float	new_player_y;
...
void	move_walk(t_player *p, float move_step)
{
	float	new_player_x;
	float	new_player_y;
